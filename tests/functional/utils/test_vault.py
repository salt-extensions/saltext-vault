...
def test_make_request_get_unauthd():
    """
...
def test_make_request_get_authd(vault_container_version):
    """
...
def test_make_request_post_json(vault_container_version):
    """
...
def test_make_request_post_data(vault_container_version):
    """
...
def test_make_request_delete(vault_container_version):
    """
...
def test_make_request_list(vault_container_version):
    """
...
def test_make_request_token_override(vault_container_version):
    """
...
def test_make_request_url_override(vault_container_version):
    """
    ...
    with pytest.raises(
        ...
        vault.make_request("GET", f"/v1/{endpoint}", vault_url="http://127.0.0.1:1", timeout=2)
