...
def vault_salt_master(
    ...
    factory = salt_factories.salt_master_daemon("vault-exemaster", defaults=vault_master_config)
...
def pillar_dual_use_tree(
    ...
    test_file = vault_salt_master.pillar_tree.base.temp_file("testvault.sls", test_pillar_contents)
...
class TestSingleUseToken:
    ...
    def test_vault_read_secret(self, vault_salt_call_cli):
        ...
        """
        ret = vault_salt_call_cli.run("vault.read_secret", "secret/test/jvmdump/ssh_key")
    ...
    def test_vault_write_secret(self, vault_salt_call_cli):
        ...
        are issued with uses=1.
        """
        ret = vault_salt_call_cli.run("vault.write_secret", "secret/test/write", success="yup")
        assert ret.returncode == 0
        assert ret.data
...
class TestTokenMinimumTTLUnrenewable:
    ...
    def vault_minion_config(self):
        return {
            "open_mode": True,
            "grains": {},
            "vault": {"auth": {"token_lifecycle": {"minimum_ttl": 178, "renew_increment": None}}},
        }
    ...
    def test_minimum_ttl_is_respected(self, vault_salt_call_cli):
        ...
        ret_new = vault_salt_call_cli.run("vault.query", "GET", "auth/token/lookup-self")
...
class TestTokenMinimumTTLRenewable:
    ...
    def vault_minion_config(self):
        return {
            "open_mode": True,
            "grains": {},
            "vault": {"auth": {"token_lifecycle": {"minimum_ttl": 177, "renew_increment": None}}},
        }
